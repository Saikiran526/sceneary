                    ...
                    Stack(
                      ...
                      children: [
                        Container(
                          ...
                          height: viewModel.searchQueryController.text.isEmpty ? 250 : 190,
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.asset(AssetsPath.profilePictureImg)
                                      ),
                                    ),
                                    SizedBox(width: 15),
                                    Column(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Container(
                                              decoration: BoxDecoration(
                                                borderRadius: BorderRadius.circular(10),
                                                color: viewModel.selectedDate == date ? primaryColor700 : primaryColor100,
                                              ),
                                              child: Center(
                                                child: Column(
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                    ...
                                    IconButton(
                                        onPressed: (){},
                                        icon: Icon(Icons.arrow_forward_ios,color: primaryColor700,)
                                    )
                                  ],
                                ),
                              ),
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    child: OutlinedButton(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Icon(Icons.keyboard_arrow_down,color: primaryColor700)
                                          ],
                                        )
                                    ),
                                  ),
                                        ...
                                        children: [
                                          Stack(
                                            children: [
                                                      ...
                                                      Row(
                                                        children: [
                                                          CircleAvatar(
                                                            ...
                                                            radius: 30,
                                                            backgroundImage: AssetImage(AssetsPath.profilePictureImg),
                                                          ),
                                                          SizedBox(width: width*0.01,),
                                                          Column(
                                                            crossAxisAlignment: CrossAxisAlignment.start,
                                              ...
                                              Positioned(
                                                  right: 80,
                                                  child: SvgPicture.asset(AssetsPath.projectInvitationItem1Img)
                                              ),
                                              Positioned(
                                                  right: 50,
                                                  child: SvgPicture.asset(AssetsPath.projectInvitationItem2Img)
                                              ),
                                              Positioned(
                                                  right: 30,
                                                  top:40,
                                                  child: SvgPicture.asset(AssetsPath.projectInvitationItem3Img)
                                              ),
                                              Positioned(
                                                  right: 10,
                                                  top:20,
                                                  child: SvgPicture.asset(AssetsPath.projectInvitationItem4Img)
                                              ),
                                            ],
                                          ),
                                          SizedBox(height: height*0.02,),
                                ...
                                Row(
                                  ...
                                  children: [
                                    quickActions(action: "Create Project", size: size, type: 'add'),
                                    quickActions(action: "My Calendar", size: size, type: 'calendar'),
                                  ],
                                ),
                                SizedBox(height: height*0.02,),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  children: [
                                    quickActions(action: "Explore People", size: size, type: 'search'),
                                    quickActions(action: "My Profile", size: size, type: 'profile'),
                                  ],
                                ),
