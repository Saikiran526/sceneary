...
import 'package:sceneary/presentation/add_shooting_schedule/view/add_shooting_schedule_step_one.dart';
import 'package:sceneary/presentation/add_shooting_schedule/viewmodel/add_shooting_schedule_viewmodel.dart';

import '../add_shooting_schedule/view/add_shooting_schedule_step_two.dart';

class EditShootingScheduleScreen extends StatelessWidget {
  const EditShootingScheduleScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Edit shooting schedule'),
      ),
                      ...
                      Expanded(
                        child: PageView(
                          ...
                          children:  [
                            ...
                            AddShootingScheduleStepTwo(viewModelSuper:viewModel,isEdit:true),
                          ],
                        ),
                      ),
