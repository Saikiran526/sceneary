  ...
  showMenu(
    ...
    items: [
          ...
          children: [
            Row(
              children: [
                ...
                SizedBox(width: 5,),
                Text("Block JD", style: TextStyle(color: Colors.black)),
              ],
            ),
          ],
        ),
      ...
      PopupMenuItem(
        ...
        child: Row(
          children: [
            SvgPicture.asset(AssetsPath.muteNotification),
                  SizedBox(width: 5,),
            Text("Mute Notifications", style: TextStyle(color: Colors.black)),
          ],
        ),
      ),
    ],
