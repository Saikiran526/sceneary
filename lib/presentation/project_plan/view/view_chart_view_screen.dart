...
import 'package:sceneary/presentation/project_plan/viewmodel/view_chart_view_viewmodel.dart';
...
class ViewChartViewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<ViewChartViewViewmodel>(
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                GestureDetector(
                  onTap: () {
                    viewModel.showFilterDailog();
                  },
                  child: SvgPicture.asset(AssetsPath.filterProjectPlan),
                ),
