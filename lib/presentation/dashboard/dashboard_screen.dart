          ...
          builder: (context,viewModel,child){
            return Scaffold(
                ...
                body: Consumer<DashboardViewModel>(
                    builder: (context,viewModel,child){
                      return [
                        viewModel.searchQueryController.text.isEmpty ? HomeScreen() : SearchResultScreen(),
                        ProjectsScreen(),
                        MessagesScreen(),
                        ProfileScreen()
                ...
                bottomNavigationBar: BottomNavigationBar(
                    ...
                    items: [
                      BottomNavigationBarItem(
                        label:'Home' ,
                        icon:viewModel.selectedIndex==0 ? SvgPicture.asset(AssetsPath.homeActiveImg) : SvgPicture.asset(AssetsPath.homeInActiveImg),
                      ),
                      BottomNavigationBarItem(
                        label: 'Projects',
                        icon:viewModel.selectedIndex==1 ? SvgPicture.asset(AssetsPath.projectsActiveImg) : SvgPicture.asset(AssetsPath.projectsInActiveImg),
                      ),
                      BottomNavigationBarItem(
                        label: 'Message',
                        icon: viewModel.selectedIndex==2 ? SvgPicture.asset(AssetsPath.messageActiveImg) : SvgPicture.asset(AssetsPath.messageInActiveImg),
                      ),
                      BottomNavigationBarItem(
                        label: 'Profile',
